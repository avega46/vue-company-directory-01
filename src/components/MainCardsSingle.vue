...
.card {
    @apply cursor-pointer overflow-hidden rounded-md bg-slate-300 p-8 shadow-md transition-transform duration-300 hover:scale-110 hover:shadow-2xl hover:shadow-slate-700;
    ...
    &-details {
        ...
        &-name {
            @apply text-2xl font-bold tracking-wider text-slate-800;
        }
        &-job {
