...
.wrapper {
    ...
    .search {
        @apply rounded-md border-0 px-8 py-4 text-slate-700 placeholder-slate-500 outline-none focus:ring-amber-600;
    }

    .icon {
        @apply absolute right-0 z-10 py-4 pr-8 text-slate-900;
    }
}
